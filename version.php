...
$plugin->version   = 2012061801; // The current module version (Date: YYYYMMDDXX)
...
$plugin->release = '1.0 (Build: 2012061801)';
$plugin->component = 'theme_scratch'; // Full name of the plugin (used for diagnostics)